...
export async function POST(request, { params }) {
  try {
    ...
    const r = await fetch(`${BACKEND}/api/projects/${id}/deep-revision`, {
      method: 'POST',
    ...
    return new Response(JSON.stringify({ error: 'Deep revision failed', message: e.message }), { status: 500, headers: { 'Content-Type': 'application/json' } });
  }
}
