...
export async function POST(request, { params }) {
  try {
    ...
    const r = await fetch(`${BACKEND}/api/projects/${id}/plot-options`, {
      method: 'POST',
    ...
    return new Response(JSON.stringify({ error: 'Plot options failed', message: e.message }), { status: 500, headers: { 'Content-Type': 'application/json' } });
  }
}
