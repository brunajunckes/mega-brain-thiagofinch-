...
export async function POST(request, { params }) {
  try {
    ...
    const r = await fetch(`${BACKEND}/api/projects/${id}/story-bible`, {
      method: 'POST',
    ...
    return new Response(JSON.stringify({ error: 'Story bible failed', message: e.message }), { status: 500, headers: { 'Content-Type': 'application/json' } });
  }
}
