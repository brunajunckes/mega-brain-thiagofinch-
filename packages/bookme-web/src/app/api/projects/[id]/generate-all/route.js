...
export async function POST(request, { params }) {
  try {
    ...
    const r = await fetch(`${BACKEND}/api/projects/${id}/generate-all`, {
      method: 'POST',
    ...
    return new Response(JSON.stringify({ error: 'Generate all failed', message: e.message }), { status: 500, headers: { 'Content-Type': 'application/json' } });
  }
}
