...
export async function POST(request, { params }) {
  try {
    ...
    const r = await fetch(`${BACKEND}/api/projects/${id}/beta-review`, {
      method: 'POST',
    ...
    return new Response(JSON.stringify({ error: 'Beta review failed', message: e.message }), { status: 500, headers: { 'Content-Type': 'application/json' } });
  }
}
